...
export default function Login() {
  ...
  return (
    <div className="login-page">
      <div className="login-box">
        <div className="login-header">
          <div className="login-logo"><img src="/logo.jpg" alt="Esencia Gale" style="width:96px;height:96px;borderRadius:50%;objectFit:cover;border:2px solid var(--primary,#D4AF37)" /></div>
